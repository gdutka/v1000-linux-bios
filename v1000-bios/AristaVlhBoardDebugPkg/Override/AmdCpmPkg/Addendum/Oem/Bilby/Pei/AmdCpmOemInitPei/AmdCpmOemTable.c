...
//         (socket,die,gpio,function,        output,           pullup)
    GPIO_DEFINITION (2,   GPIO_FUNCTION_1,  GPIO_OUTPUT_LOW,  GPIO_PU_EN,     GPIO_STICKY_DIS),   // (Arista: CPU_DEBUG_LED1)
    GPIO_DEFINITION (3,   GPIO_FUNCTION_0,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // KR10G_XCVR_INTR0# (Arista: CPLD_INT_L)
    GPIO_DEFINITION (4,   GPIO_FUNCTION_0,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // KR10G_XCVR_INTR1# (Arista: CPU_NMI)
    GPIO_DEFINITION (5,   GPIO_FUNCTION_0,  GPIO_INPUT,       GPIO_PD_EN,     GPIO_STICKY_DIS),   // SSD_DEVSLP	(Arista: BRD_ID0)
    ...
    GPIO_DEFINITION (14,  GPIO_FUNCTION_1,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC4# Arista: CPU_TPM_SPI_IRQ_L
    GPIO_DEFINITION (16,  GPIO_FUNCTION_0,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC0#
    GPIO_DEFINITION (17,  GPIO_FUNCTION_1,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC1# (Arista: PCIE_WAKE_L)
    GPIO_DEFINITION (18,  GPIO_FUNCTION_1,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC2# (Arista: PCIE_RST1_L_ALT)
	GPIO_DEFINITION (19,  GPIO_FUNCTION_1,  GPIO_NA, GPIO_PU_EN,     GPIO_STICKY_DIS),   // (Arista: APU_I2C0_SCL)
	GPIO_DEFINITION (20,  GPIO_FUNCTION_1,  GPIO_NA, GPIO_PU_EN,     GPIO_STICKY_DIS),   // (Arista: APU_I2C0_SDA)
    GPIO_DEFINITION (22,  GPIO_FUNCTION_2,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   //AGPIO22 - not used in Arista
    ...
    GPIO_DEFINITION (40,  GPIO_FUNCTION_0,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // MDIO_SDAT0 (SFP+_SDAT or PHY0_MDIO_DATA) (Arista: BRD_ID3)
    GPIO_DEFINITION (41,  GPIO_FUNCTION_0,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // EGPIO41
    GPIO_DEFINITION (42,  GPIO_FUNCTION_0,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // GPP_10G_SELECT => High=10G, Low=x2  NVME ( work with AGPIO89)(Arista: USB_ENABLE)
    ...
    GPIO_DEFINITION (84,  GPIO_FUNCTION_1,  GPIO_OUTPUT_LOW,  GPIO_PU_EN,     GPIO_STICKY_DIS),   // FANTACH0 (Arista: CPU_FPGA_TMS)
    GPIO_DEFINITION (85,  GPIO_FUNCTION_1,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // FANOUT0 (Arista: CPU_FPGA_TCK)
    GPIO_DEFINITION (86,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // AGPIO86 => High for LPC and Low for eMMC & SD (Need reworks for SD)Arista: FPGA_CRC_ERR
    ...
    GPIO_DEFINITION (91,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PD_EN,     GPIO_STICKY_DIS),   // PC_BEEP
	...
	GPIO_DEFINITION (113,  GPIO_FUNCTION_2,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS), 
    ...
    GPIO_DEFINITION (142, GPIO_FUNCTION_2,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // UART1_RTS_L, UART3_RXD, EGPIO Arista:WD_IRQ		       
    {0xFF},
  }
};
...
//    GEVENT_DEFINITION (0x02,  EVENT_ENABLE, SCITRIG_LOW,  SCILEVEL_EDGE,  SMISCI_DISABLE, SCIS0_DISABLE,  SCIMAP_02,  SMITRIG_HI,   SMICONTROL_DISABLE), // GEVENT02: DP_HPD_DIG
    GEVENT_DEFINITION (0x03,  EVENT_ENABLE, SCITRIG_LOW,  SCILEVEL_EDGE,  SMISCI_DISABLE, SCIS0_DISABLE,  SCIMAP_03,  SMITRIG_LOW,   SMICONTROL_IRQ13), // GEVENT03: EC_SCI#
    GEVENT_DEFINITION (0x04,  EVENT_ENABLE, SCITRIG_LOW,  SCILEVEL_EDGE,  SMISCI_DISABLE, SCIS0_DISABLE,  SCIMAP_04,  SMITRIG_LOW,   SMICONTROL_NMI),     // GEVENT04: DASH_SMI Arista: CPU_NMI from switch card
...
//    GEVENT_DEFINITION (0x08,  EVENT_ENABLE, SCITRIG_LOW,  SCILEVEL_EDGE,  SMISCI_DISABLE, SCIS0_DISABLE,  SCIMAP_08,  SMITRIG_HI,   SMICONTROL_DISABLE), // GEVENT08: PCIE_WAKE_UP#/WAKE_ON_WAN#
    GEVENT_DEFINITION (0x09,  EVENT_ENABLE, SCITRIG_LOW,  SCILEVEL_EDGE,  SMISCI_DISABLE, SCIS0_DISABLE,  SCIMAP_09,  SMITRIG_HI,  SMICONTROL_IRQ13), // GEVENT09: Arista: FPGA_CRC_ERR 
...
//        (socket,die, ClkId,     ClkReq,     DeviceId,       Device,Function,SlotCheck)
    //PCIE_INCLK (0, 0,  GPP_CLK0,  CLK_REQ0,   DEVICE_ID_MXM,  1,     1,       CLKPM_CHECK), // MXM
...
//            {mPortPresent, mDevAddress, mDevFunction, mMaxLinkSpeed, mAspm, mAspmL1_1, mAspmL1_2, 0, mHotplug, {0, mMaxLinkCap, 0, mClkPmSupport}, {0, 0, 0}, DxioEndpointDetect}
    ...
    { // DEVICE_ID_DT                         Entry 1
	  //CPU_MAC_PCIE GPP Lane 0
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 4, 4, HotPluggableDisabled, 1),
      DXIO_PORT_DATA_INITIALIZER_PCIE_V2 (
    ...
    { // PCIE M.2 x2                         Entry 2
     0,
     DXIO_ENGINE_DATA_INITIALIZER(DxioUnusedEngine, 5, 7, HotPluggableDisabled, DEVICE_ID_SSD),
     DXIO_PORT_DATA_INITIALIZER_PCIE_V2(
       DxioPortDisabled,                      // Port Present
       1,                                    // Requested Device
    ...
    { // DEVICE_ID_DT                         Entry 3
	  //CPU_SGMII_PCIE GPP Lane 4
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 0, 0, HotPluggableDisabled, 1),
      DXIO_PORT_DATA_INITIALIZER_PCIE_V2 (
        DxioPortEnabled,                      // Port Present
        1,                                    // Requested Device
        2,                                    // Requested Function
    ...
    { // PCIE M.2 x4                         Entry 4
     0,
     DXIO_ENGINE_DATA_INITIALIZER(DxioUnusedEngine, 1, 3, HotPluggableDisabled, DEVICE_ID_SSD),
     DXIO_PORT_DATA_INITIALIZER_PCIE_V2(
       DxioPortDisabled,                      // Port Present
       1,                                    // Requested Device
       5,                                    // Requested Function
    ...
    { // DEVICE_ID_SATA_EXPRESS    iSata         Entry 5
      0,
    ...
    { // P0 - Ehernet Port 0        		Entry 6
      ...
      DXIO_PORT_DATA_INITIALIZER_ENET (
        ...
        0x9297c4d8,  /// mMacAddressLo,    (TO BE FILLED IN BY CODE)
        0x8000b402,  /// mMacAddressHi,    (TO BE FILLED IN BY CODE)
        0,  /// mTxEqPre,
        32,  /// mTxEqMain,
        32   /// mTxEqPost
      )
    ...
    {   // P1 - Ethernet Port1      	//entry 7
        ...
        0,    /// mPadMux1, 		(Pad Mux Setting)
        0x9297c4d8,  /// mMacAddressLo,    (TO BE FILLED IN BY CODE)
        0x8000b502,  /// mMacAddressHi,    (TO BE FILLED IN BY CODE)
        0,  /// mTxEqPre,
        32,  /// mTxEqMain,
        32   /// mTxEqPost
      )
...
//  {mPortPresent, mDevAddress, mDevFunction, mMaxLinkSpeed, mAspm, mAspmL1_1, mAspmL1_2, 0, mHotplug, {0, mMaxLinkCap, 0, mClkPmSupport}, {0, 0, 0}, DxioEndpointDetect}
    { // DEVICE_ID_MXM                        Entry 0
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioUnusedEngine, 11, 8, HotPluggableDisabled, DEVICE_ID_MXM),
      DXIO_PORT_DATA_INITIALIZER_PCIE_V2 (
        DxioPortDisabled,                      // Port Present
        1,                                    // Requested Device
        2,                                    // Requested Function
    ...
    { // DEVICE_ID_DT                       Entry 1
      ...
      DXIO_PORT_DATA_INITIALIZER_PCIE_V2 (
        ...
        DxioAspmDisabled,                   // ASPM L1.1  // 0:disabled, 1:Enabled
        DxioAspmDisabled,                   // ASPM L1.2  // 0:disabled, 1:Enabled
        DxioClkPmSupportDisabled,             // Clock PM
        CLK_REQ4                              // CLKREQ#
      )
    },
    ...
    { // P0 - Ehernet Port 0        		Entry 6
      ...
      DXIO_PORT_DATA_INITIALIZER_ENET (
        DxioPortEnabled,            // Port Present
        0,    /// mPortNum
        0,    /// mPlatConf 		(10G Base T => Default, 8 = SFP+)
        0,    /// mMdioId           (If MDIO is not used by this port, set this to 0)
        0xD,  /// mSuppSpeed		(For SFP+ connectors, 10G, 1G and 100M support should be indicated)
        2,    /// mConnType  		(1 = SFP+ Connection I2C interface, 2 = MDIO PHY)
        0,    /// mMdioReset 		(MDIO Reset Type, Integrated GPIO)
        0,    /// mMdioGpioResetNum (Integrated GPIO number for reset)
        1,    /// mSfpGpioAdd 		(Lower I2C address of GPIO Expander PCA9535)
        0xE,  /// mTxFault,		    (I/O1_6 connected SFP+_XGB0_TX_FAULT 0_0 to 0_7 = 8 , 1_0 to 1_6 = 7 , 8+7= 15-1 = E ( -1 for excluding for 0)
    ...
    {   // P1 - Ethernet Port1      	//entry 7
        DESCRIPTOR_TERMINATE_LIST,
        DXIO_ENGINE_DATA_INITIALIZER (DxioUnusedEngine, 1, 1, HotPluggableDisabled, 1),
        DXIO_PORT_DATA_INITIALIZER_ENET (
        DxioPortDisabled,            // Port Present
        1,    /// mPortNum
        8,    /// mPlatConf 		(10G Base T => Default, 8 = SFP+)
  ...
  )
{
  ...
  //UINT32                            Value32;
//[-start-181221-IB09860035-add]//
  H2O_GPIO_INIT_STRUCT     *GpioList;
  UINT32                   GpioTableCount;
  UINTN                    GpioIndex;
  UINTN                    GpioCount;
  BOOLEAN                  GpioEndExist;
//[-start-181222-IB09860036-add]//
  AMD_CPM_GPIO_ITEM        OemGpioList[AMD_GPIO_ITEM_SIZE] = {{0}};
//[-end-181222-IB09860036-add]//
  GpioList     = NULL;
  GpioTableCount = 0;
  GpioCount = 0;
...
//[-start-181221-IB09860035-add]//
  if (PcdGetBool (PcdH2OGpioCfgSupported)) {
    Status = GetGpioCfg(0, &GpioList, &GpioTableCount);
    if (EFI_ERROR (Status)) {
      DEBUG ((DEBUG_ERROR, "GetGpioCfg() failed\n"));
    } else {
      for (GpioIndex = 0; GpioIndex < GpioTableCount; GpioIndex++) {
        if (GpioList[GpioIndex].Enable) {
          if (GpioList[GpioIndex].Gpio.Pin == 0xFF) {
            GpioEndExist = TRUE;
          }
          CopyMem (&GpioInitTablePtr->GpioList[GpioCount], \
                   &GpioList[GpioIndex].Gpio, \
                   sizeof (AMD_CPM_GPIO_ITEM) \
                   );
          DEBUG ((DEBUG_ERROR, "The Gpio pin %d\n", GpioList[GpioIndex].Gpio.Pin));
          GpioCount++;
          if (GpioCount >= AMD_GPIO_ITEM_SIZE) {
            if (!GpioEndExist) {
              GpioInitTablePtr->GpioList[0xFF].Pin = 0xFF;
            }
            DEBUG ((DEBUG_ERROR, "The Gpio item over %d, The over item will not program\n", AMD_GPIO_ITEM_SIZE));
            break;
          }
        }
      }
      if (!GpioEndExist && (GpioCount < AMD_GPIO_ITEM_SIZE)) {
        GpioInitTablePtr->GpioList[GpioCount].Pin = 0xFF;
      }
    }
  }
//[-end-181221-IB09860035-add]//
...
//[-start-200219-IB06070081-modify]//
  ...
  } else if ((FixedPcdGet8 (PcdFchUartPort) == 1) || (PcdGet64 (PcdSerialRegisterBase) == 0xFEDCA000) || (PcdGet64 (PcdAmdIdsDebugPrintSerialPort) == 0xFEDCA000)) {
    DeviceEnableMap |= BIT12;
    PcdSet32(FchRTDeviceEnableMap, DeviceEnableMap);
  }
//[-end-200219-IB06070081-modify]//
...
//[-start-181222-IB09860036-add]//
  ...
  if (Status == EFI_MEDIA_CHANGED) {
    CopyMem (&GpioInitTablePtr->GpioList, &OemGpioList, sizeof(GpioInitTablePtr->GpioList));
  }
//[-end-181222-IB09860036-add]//
