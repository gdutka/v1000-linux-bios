  ...
  )
{
  ...
  //
  ASSERT (PcdGet32 (PcdMaximumUnicodeStringLength) == 0 || StrSize (Destination) != 0);
  return Destination;
}
  ...
  )
{
  ...
  // Length tests are performed inside StrLen().
  //
  ASSERT (PcdGet32 (PcdMaximumUnicodeStringLength) == 0 || StrSize (Source) != 0);
  ...
  )
{
  ...
  // PcdMaximumUnicodeStringLength is tested inside StrLen().
  //
  ASSERT (PcdGet32 (PcdMaximumUnicodeStringLength) == 0 || AsciiStrSize (Destination) != 0);
  return Destination;
}
  ...
  )
{
  ...
  *Destination = '\0';
  ...
  //
  ASSERT (PcdGet32 (PcdMaximumUnicodeStringLength) == 0 || StrSize (ReturnValue) != 0);
