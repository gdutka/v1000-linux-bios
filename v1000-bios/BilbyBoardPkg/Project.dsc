...
[Defines]
  ...
  !if $(CONNECTED_STANDBY_SUPPORT) == YES
    DEFINE CC_FLAGS              = $(CC_FLAGS) /D CONNECTED_STANDBY_SUPPORT
  !endif

  !if $(REDUCED_HARDWARE_SUPPORT) == YES
    DEFINE CC_FLAGS              = $(CC_FLAGS) /D REDUCED_HARDWARE_SUPPORT
  !endif
...
#[-start-181112-IB06070003-modify]#
  gInsydeCrTokenSpaceGuid.PcdH2OCrDevice|{  \
    UINT8(0x01), L"UART0"         , L"VenHw(E76FD4E9-0A30-4CA9-9540-D799534CC4FF,0090DCFE00000000)/Uart(115200,8,N,1)",  \
...
!endif
  ...
  gEfiAmdAgesaModulePkgTokenSpaceGuid.PcdXgbePort1ConfigEn|TRUE #XGbE controller Port Config Enable/disable
...
!if $(EMULATION_ONLY) == YES
  *_*_*_CC_FLAGS           = /D EMULATION_ONLY
!endif
