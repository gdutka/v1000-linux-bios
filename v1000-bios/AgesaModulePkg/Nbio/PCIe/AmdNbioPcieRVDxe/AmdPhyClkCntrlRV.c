...

{
  ...
  if ((PcdGet8 (PcdPhyA0DynamicControl) == 1) && (Usage.PHY_A0_PCIe == FALSE)) {
    ...
    SmnRegisterRMW (GnbHandle->Address.Address.Bus,
                    ...
                    (UINT32)~(CGPLLCntrlReg5_CLKGEN_PHY_A0_Refclk_Static_Disable_MASK),
    ...
    SmnRegisterRMW (GnbHandle->Address.Address.Bus,
                    SMN_CGPLLCntrlReg5_ADDRESS,
                    (UINT32)~(CGPLLCntrlReg5_CLKGEN_PHY_A0_Refclk_Dynamic_EnB_MASK),
  ...
  if ((PcdGet8 (PcdPhyA1DynamicControl) == 1) && (Usage.PHY_A1_SATA == FALSE)) {
    if (TRUE == SataDrivePresent) {
        ...
        SmnRegisterRMW (GnbHandle->Address.Address.Bus,
                        SMN_CGPLLCntrlReg5_ADDRESS,
                        (UINT32)~(CGPLLCntrlReg5_CLKGEN_PHY_A1_SataMac_En_MASK |
      ...
      SmnRegisterRMW (GnbHandle->Address.Address.Bus,
                      SMN_CGPLLCntrlReg5_ADDRESS,
                      (UINT32)~(CGPLLCntrlReg5_CLKGEN_PHY_A1_Refclk_Static_Disable_MASK),
    ...
    SmnRegisterRMW (GnbHandle->Address.Address.Bus,
                    SMN_CGPLLCntrlReg5_ADDRESS,
                    (UINT32)~(CGPLLCntrlReg5_CLKGEN_PHY_A1_Refclk_Dynamic_EnB_MASK),
  ...
  if ((PcdGet8 (PcdPhyA2DynamicControl) == 1) && (Usage.PHY_A2_PCIe == FALSE)) {
    ...
    SmnRegisterRMW (GnbHandle->Address.Address.Bus,
                    ...
                    (UINT32)~(CGPLLCntrlReg6_CLKGEN_PHY_A2_Refclk_Static_Disable_MASK),
    ...
    SmnRegisterRMW (GnbHandle->Address.Address.Bus,
                    SMN_CGPLLCntrlReg6_ADDRESS,
                    (UINT32)~(CGPLLCntrlReg6_CLKGEN_PHY_A2_Refclk_Dynamic_EnB_MASK),
  ...
  if ((PcdGet8 (PcdPhyA34DynamicControl) == 1) && (Usage.PHY_A0_PCIe == FALSE) &&
    ...
    SmnRegisterRMW (GnbHandle->Address.Address.Bus,
                    SMN_CGPLLCntrlReg6_ADDRESS,
                    (UINT32)~(CGPLLCntrlReg6_CLKGEN_PHY_A3_4_Refclk_Static_Disable_MASK),
    ...
    SmnRegisterRMW (GnbHandle->Address.Address.Bus,
                    SMN_CGPLLCntrlReg6_ADDRESS,
                    (UINT32)~(CGPLLCntrlReg6_CLKGEN_PHY_A3_4_Refclk_Dynamic_EnB_MASK),
  ...
  if (EnableDynamicControl == TRUE) {
    ...
    SmnRegisterRMW(GnbHandle->Address.Address.Bus,
                    ...
                    (UINT32)~(MiscClkCntl4_PCIe_PHY_A_Refclk_Global_Dynamic_EnB_MASK),
