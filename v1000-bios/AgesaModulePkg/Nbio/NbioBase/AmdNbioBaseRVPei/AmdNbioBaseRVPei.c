  ...
  )
{
  ...
  while (GnbHandle != NULL) {
    ...
    MmioWrite32 (MMIO_CGPLLCntrlReg5_ADDRESS, 0);
    //SMN_CGPLLCntrlReg6_ADDRESS
    MmioWrite32 (MMIO_CGPLLCntrlReg6_ADDRESS, 0);
  ...
  )
{
  ...
  AmdNbioBaseInit ((CONST EFI_PEI_SERVICES**)PeiServices);
