...
)
{
  ...
  SmuArg[0] = 0;
  IDS_HDT_CONSOLE (MAIN_FLOW, "BIOSSMC_MSG_EnableNVMESelfRefresh: smuArg[0] = 0%x\n", SmuArg[0]);
  Status = NbioSmuServiceRequestV10 (NbioGetHostPciAddress (NbioHandle), BIOSSMC_MSG_EnableNVMESelfRefresh, SmuArg, 0);
  IDS_HDT_CONSOLE (MAIN_FLOW, "BIOSSMC_MSG_EnableNVMESelfRefresh: Status = %x,%d,%r \n", Status,Status,Status);
  ...
  )
{
  ...
  Status = gBS->LocateProtocol (
                  ...
                  NULL,
                  (VOID**)&CcxDxeInitCompleteProtocol
                  );
  if (EFI_ERROR (Status)) {
    return;
  }
...
//<Embedded_Override_End>
  ...
  if ((LogicalId.Family & AMD_FAMILY_RV2) != 0) {
    ...
    IDS_HDT_CONSOLE (MAIN_FLOW, "RV1 or PCO:EmbeddedPlatformEn \n");
  }
  //<Embedded_Override_End>
