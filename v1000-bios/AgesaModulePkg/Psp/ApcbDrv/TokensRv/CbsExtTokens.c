...
TOKEN_PAIR CbsExtTokenPair[] = {
  ...
  { APCB_ID_CBS_CMN_PERSISTENT_LOW,                   APCB_TOKEN_CBS_CMN_PERSISTENT_LOW             },
  { APCB_ID_CBS_CMN_PERSISTENT_HIGH,                  APCB_TOKEN_CBS_CMN_PERSISTENT_HIGH            },
  { APCB_ID_CBS_CMN_PERSISTENT_SIZE_LOW,              APCB_TOKEN_CBS_CMN_PERSISTENT_SIZE_LOW             },
  { APCB_ID_CBS_CMN_PERSISTENT_SIZE_HIGH,             APCB_TOKEN_CBS_CMN_PERSISTENT_SIZE_HIGH            },  
};
