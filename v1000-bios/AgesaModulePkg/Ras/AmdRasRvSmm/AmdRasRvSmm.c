...
//[-start-240426-IB18160212-modify-]//
  pLocalSmiStatusList[gSmst->CurrentlyExecutingCpu].Value = (UINT64)BspSmmSaveState->LocalSmiStatus;
  if (pLocalSmiStatusList[gSmst->CurrentlyExecutingCpu].Value != 0) {
