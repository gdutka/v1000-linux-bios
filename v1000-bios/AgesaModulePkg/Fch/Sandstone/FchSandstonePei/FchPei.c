...
//[-start-240426-IB18160212-modify-]//
  ...
  AcpiPm1Ctl  = LibFchPmIoRead16 ((CONST EFI_PEI_SERVICES**)PeiServices, FCH_PMIOA_REG62);

  // get the boot mode as seen by the south bridge
  FchBootMode = (CpuIo->IoRead16 ((CONST EFI_PEI_SERVICES**)PeiServices, (CONST EFI_PEI_CPU_IO_PPI*)CpuIo, AcpiPm1Ctl) & ACPI_BM_MASK);
//[-start-240426-IB18160212-modify-]//
