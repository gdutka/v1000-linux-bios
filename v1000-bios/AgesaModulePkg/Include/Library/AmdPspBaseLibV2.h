...
/// Structure for image slot entry
typedef struct {
  UINT32 Priority;
...
typedef struct {
  UINT32            SlotCount;
  UINT8             BootableSlotCount;
  UINT8             BootableSlotArray[MAX_IMAGE_SLOT_COUNT];
  UINT8             UnbootableSlotCount;
  UINT8             UnbootableSlotArray[MAX_IMAGE_SLOT_COUNT];
  UINT8             ActiveSlotIndex;
  IMAGE_SLOT_HEADER ActiveSlotHeader;
  UINT8             AlternativeSlotIndex;
  IMAGE_SLOT_HEADER AlternativeSlotHeader;
} IMAGE_SLOT_INFO;
