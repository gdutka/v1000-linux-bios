...
///ABL Serial Console Debugger
///This option is opened for UNSECURE parts only.
typedef enum {
  IDSOPT_DBG_CPU_GEN_ABL_CON_DBG_AUTO = 0xFF,///<Auto
  IDSOPT_DBG_CPU_GEN_ABL_CON_DBG_DISABLED = 0,///<Disabled
  IDSOPT_DBG_CPU_GEN_ABL_CON_DBG_ENABLED = 1,///<Enabled
} IDSOPT_DBG_CPU_GEN_ABL_CON_DBG;
...
typedef enum {
  ...
  IDSOPT_DBG_CPU_ACPI_C3_CTL_CST = 1,///<CST
  IDSOPT_DBG_CPU_ACPI_C3_CTL_LPI = 2,///<LPI
  IDSOPT_DBG_CPU_ACPI_C3_CTL_AUTO = 0xFF,///<Auto
...
///CST C1 Latency
///in microseconds (decimal value)
#define IDSOPT_DBG_CPU_CST_C1_LATENCY_MIN 0 ///< Min of CST C1 Latency
#define IDSOPT_DBG_CPU_CST_C1_LATENCY_MAX 5000 ///< Max of CST C1 Latency

///CST C2 Latency
///in microseconds (decimal value)
#define IDSOPT_DBG_CPU_CST_C2_LATENCY_MIN 0 ///< Min of CST C2 Latency
#define IDSOPT_DBG_CPU_CST_C2_LATENCY_MAX 5000 ///< Max of CST C2 Latency

///CST C3 Latency
///in microseconds (decimal value)
#define IDSOPT_DBG_CPU_CST_C3_LATENCY_MIN 0 ///< Min of CST C3 Latency
#define IDSOPT_DBG_CPU_CST_C3_LATENCY_MAX 5000 ///< Max of CST C3 Latency

///LPI C1 Min Residency
///in microseconds (decimal value)
#define IDSOPT_DBG_CPU_LPI_C1_MIN_RESIDENCY_MIN 0 ///< Min of LPI C1 Min Residency
#define IDSOPT_DBG_CPU_LPI_C1_MIN_RESIDENCY_MAX 5000 ///< Max of LPI C1 Min Residency

///LPI C2 Min Residency
///in microseconds (decimal value)
#define IDSOPT_DBG_CPU_LPI_C2_MIN_RESIDENCY_MIN 0 ///< Min of LPI C2 Min Residency
#define IDSOPT_DBG_CPU_LPI_C2_MIN_RESIDENCY_MAX 5000 ///< Max of LPI C2 Min Residency

///LPI C3 Min Residency
///in microseconds (decimal value)
#define IDSOPT_DBG_CPU_LPI_C3_MIN_RESIDENCY_MIN 0 ///< Min of LPI C3 Min Residency
#define IDSOPT_DBG_CPU_LPI_C3_MIN_RESIDENCY_MAX 5000 ///< Max of LPI C3 Min Residency

///LPI C1 Worst Case Wakeup Latency
///in microseconds (decimal value)
#define IDSOPT_DBG_CPU_LPI_C1_WORST_CASE_WAKEUP_LATENCY_MIN 0 ///< Min of LPI C1 Worst Case Wakeup Latency
#define IDSOPT_DBG_CPU_LPI_C1_WORST_CASE_WAKEUP_LATENCY_MAX 5000 ///< Max of LPI C1 Worst Case Wakeup Latency

///LPI C2 Worst Case Wakeup Latency
///in microseconds (decimal value)
#define IDSOPT_DBG_CPU_LPI_C2_WORST_CASE_WAKEUP_LATENCY_MIN 0 ///< Min of LPI C2 Worst Case Wakeup Latency
#define IDSOPT_DBG_CPU_LPI_C2_WORST_CASE_WAKEUP_LATENCY_MAX 5000 ///< Max of LPI C2 Worst Case Wakeup Latency

///LPI C3 Worst Case Wakeup Latency
///in microseconds (decimal value)
#define IDSOPT_DBG_CPU_LPI_C3_WORST_CASE_WAKEUP_LATENCY_MIN 0 ///< Min of LPI C3 Worst Case Wakeup Latency
#define IDSOPT_DBG_CPU_LPI_C3_WORST_CASE_WAKEUP_LATENCY_MAX 5000 ///< Max of LPI C3 Worst Case Wakeup Latency
...
typedef enum {
  ...
  IDSOPT_DBG_FCH_SPI_SPEED_800KHZ = 6,///<800kHz
...
///Sata D3Cold enable
///Enable or disable Sata D3Cold.
typedef enum {
  IDSOPT_DBG_FCH_SATA_D3_COLD_EN_DISABLED = 0,///<Disabled
  IDSOPT_DBG_FCH_SATA_D3_COLD_EN_ENABLED = 1,///<Enabled
  IDSOPT_DBG_FCH_SATA_D3_COLD_EN_AUTO = 0xf,///<Auto
} IDSOPT_DBG_FCH_SATA_D3_COLD_EN;
...
///Auto = Use the default value\nManual = User can set customized Cclk Frequency in MHz
typedef enum {
  IDSOPT_DBG_CCLK_FREQ_CTL_AUTO = 0,///<Auto
  IDSOPT_DBG_CCLK_FREQ_CTL_MANUAL = 1,///<Manual
} IDSOPT_DBG_CCLK_FREQ_CTL;

///CCLK Max
///CCLK Max Frequency in MHz
#define IDSOPT_DBG_CCLK_MAX_MIN 0 ///< Min of CCLK Max
#define IDSOPT_DBG_CCLK_MAX_MAX 0xffff ///< Max of CCLK Max

///CCLK Min
///CCLK Min Frequency in MHz
#define IDSOPT_DBG_CCLK_MIN_MIN 0 ///< Min of CCLK Min
#define IDSOPT_DBG_CCLK_MIN_MAX 0xffff ///< Max of CCLK Min
...
///STT_MinLimit Control
///Auto = 0
typedef enum {
  IDSOPT_DBG_NBIO_STT_MIN_LIMIT_CTL_MANUAL = 1,///<Manual
  IDSOPT_DBG_NBIO_STT_MIN_LIMIT_CTL_AUTO = 0,///<Auto
} IDSOPT_DBG_NBIO_STT_MIN_LIMIT_CTL;

///STT Min Limit
///STT Min Limit mW
#define IDSOPT_DBG_NBIO_STT_MIN_LIMIT_MIN 0 ///< Min of STT Min Limit
#define IDSOPT_DBG_NBIO_STT_MIN_LIMIT_MAX 0xffffffff ///< Max of STT Min Limit
...
///Fmax Temp Threshold Control
///Auto = Use the default FmaxTempThreshold\nManual = User can set FmaxTempThreshold
typedef enum {
  IDSOPT_DBG_FMAX_TEMP_THRESHOLD_CTRL_MANUAL = 1,///<Manual
  IDSOPT_DBG_FMAX_TEMP_THRESHOLD_CTRL_AUTO = 0,///<Auto
} IDSOPT_DBG_FMAX_TEMP_THRESHOLD_CTRL;

///FmaxTempThreshold
///FmaxTempThreshold
#define IDSOPT_DBG_FMAX_TEMP_THRESHOLD_MIN 0 ///< Min of FmaxTempThreshold
#define IDSOPT_DBG_FMAX_TEMP_THRESHOLD_MAX 0xff ///< Max of FmaxTempThreshold

///Fmax Temp Frequency Control
///Auto = Use the default FmaxTempFrequency\nManual = User can set FmaxTempFrequency
typedef enum {
  IDSOPT_DBG_FMAX_TEMP_FREQUENCY_CTRL_MANUAL = 1,///<Manual
  IDSOPT_DBG_FMAX_TEMP_FREQUENCY_CTRL_AUTO = 0,///<Auto
} IDSOPT_DBG_FMAX_TEMP_FREQUENCY_CTRL;

///FmaxTempFrequency
///FmaxTempFrequency
#define IDSOPT_DBG_FMAX_TEMP_FREQUENCY_MIN 0 ///< Min of FmaxTempFrequency
#define IDSOPT_DBG_FMAX_TEMP_FREQUENCY_MAX 0xffff ///< Max of FmaxTempFrequency
...
///SlowPPTLimitApuOnly
///APU Only sPPT Limit = user enter in mW
#define IDSOPT_DBG_SLOW_PPT_LIMIT_APU_ONLY_MIN 0 ///< Min of SlowPPTLimitApuOnly
#define IDSOPT_DBG_SLOW_PPT_LIMIT_APU_ONLY_MAX 0xffff ///< Max of SlowPPTLimitApuOnly
...
///Voltage_SlewRate
///Voltage SlewRate
#define IDSOPT_DBG_VOLTAGE_SLEW_RATE_MIN 0 ///< Min of Voltage_SlewRate
#define IDSOPT_DBG_VOLTAGE_SLEW_RATE_MAX 0xff ///< Max of Voltage_SlewRate
...
///Aclk Dpm0 Freq 400MHz
///1 : 400Mhz\n0 : 200Mhz
typedef enum {
  IDSOPT_DBG_ACLK_DPM0_FREQ_0 = 0,///<0
  IDSOPT_DBG_ACLK_DPM0_FREQ_1 = 1,///<1
  IDSOPT_DBG_ACLK_DPM0_FREQ_AUTO = 0xF,///<Auto
} IDSOPT_DBG_ACLK_DPM0_FREQ;
