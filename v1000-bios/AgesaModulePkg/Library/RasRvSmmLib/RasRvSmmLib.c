  ...
  )
{
    ...
    if (ProcessorNumber == gSmst->CurrentlyExecutingCpu) {
      RasSmmMsrWrite((VOID*)RasMsrAccess);
    } else {
  ...
  )
{
	...
	//[-start-240426-IB18160212-modify-]//
    if (ProcessorNumber == gSmst->CurrentlyExecutingCpu) {
      RasSmmMsrRead ((VOID*)RasMsrAccess);
    } else {
      gSmst->SmmStartupThisAp(
            RasSmmMsrRead,
            ProcessorNumber,
...
//[-start-240426-IB18160212-modify-]//
  //Program BSP first
  SetMcaThreshold((VOID*)RasThresholdConfig);
  ...
  )
{
  ...
  //Program BSP first
  //[-start-240426-IB18160212-modify-]//
  if (RasMcaErrorInfo->CpuInfo.ProcessorNumber == gSmst->CurrentlyExecutingCpu) {
