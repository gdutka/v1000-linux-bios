;** @file
;
;  This is the assembly code for AMD64 MP support.
;
;******************************************************************************
...
extern  ASM_PFX(mBspSwitched)
extern  ASM_PFX(mNewProcessorNumber)
extern  ASM_PFX(mMonitorDataAddress)
...
extern ASM_PFX(ApProtectedModeThunk) ;externdef ASM_PFX(ApProtectedModeThunk)
...
GetProcNumber:
        ...
        add         edi, 8
        inc         ecx
        cmp         ecx, dword [esi + ApCountLocation]
        jbe         GetProcNumber
...
Found:
        ...
        xor         rbx, rbx                          
        mov         qword [rsp + 0Ch], rbx        ; Clean ReadyToBoot Flag
...
WakeUpThisAp:
        ...
        ;
        mov         rax, mBspSwitched
        cmp         byte [rax], 0
        jz          CheckReadyToBoot

        mov         byte [rax], 0                 ;clear BSP switch flag

        mov         rax, mNewProcessorNumber
        ...
        ;
        mov         rax, mMonitorDataAddress
        mov         rsp, [rax]
        
CheckReadyToBoot:
        mov         eax, dword [esi]          ; eax = ApLoopMode for POST
        cmp         byte [rsp + 0Ch], 1       ; Check ReadyToBoot flag?
...
ApMwaitLoop:
        ...
        mov         rax, qword [rsp + 4]      ; Mwait Cx, Target C-State per rax[7:4]
        DB          0fh, 1, 0c9h                  ; MWAIT
...
ASM_PFX(AsmGetAddressMap):
        ...
        mov         qword [rcx+30h], ProtectedModeEntryPoint - RendezvousFunnelProcStart
