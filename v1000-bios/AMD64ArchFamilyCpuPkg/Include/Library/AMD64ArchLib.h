/** @file
  ...
  apply to CPUs that fit into an LGA775 socket.
...
#ifndef __AMD64_ARCH_LIB_H__
#define __AMD64_ARCH_LIB_H__
...
///
///
#define SOCKET_TEMP_SMM_MIN_REV_ID_IOMISC  0x30004
#define SOCKET_TEMP_SMM_MIN_REV_ID_x64     0x30006
...
typedef union {
  ...
  UINT32  Uint32;
} SOCKET_AMD64_SMM_CPU_STATE_IOMISC;
...
typedef struct {
  ...
  UINT64  _CR3;              // fff0h
  UINT64  _CR0;              // fff8h
} SOCKET_AMD64_SMM_CPU_STATE64;

///
/// Union of CPU save-state strcutures for IA32 and X64.
///
typedef union  {
  SOCKET_AMD64_SMM_CPU_STATE32  x86;
  SOCKET_AMD64_SMM_CPU_STATE64  x64;
} SOCKET_AMD64_SMM_CPU_STATE;
