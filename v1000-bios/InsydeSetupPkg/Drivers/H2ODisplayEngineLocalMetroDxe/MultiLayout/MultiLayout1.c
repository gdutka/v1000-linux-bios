...
CHAR16 *mScreenPanelChilds = L""
  ...
  L"<H2OSetupMenuPanel border-color='0x70FFFFFF' name='H2OSetupMenuPanel' padding='2,2,2,2'/>"
  ...
  L"<H2OHotkeyPanel border-color='0x70FFFFFF' name='H2OHotkeyPanel' padding='15,10,10,10' background-color='0x0'/>"
...
CHAR16 *mOwnerDrawPanelChilds = L""
  L"<Control>"
    L"<Texture name='OwnerDrawBackground' float='true' height='match_parent' width='match_parent' background-image='@OwnerDrawBkg' background-color='0xFF333333'/>"
...
CHAR16 *mFormTitlePanelChilds = L""
  L"<HorizontalLayout background-color='0x0' height='match_parent'>"
    ...
    L"</Control>"
    L"<Label background-color='0x0' padding='15,0,15,8' width='1500' textcolor='0xFFFFFFFF' font-size='30' name='TitleName'/>"
  L"</HorizontalLayout>";
...
CHAR16 *mHelpTextPanelChilds = L""
  ...
  L"<VerticalLayout padding='40,30,40,30' width='match_parent' float='true' name='HelpMenu' height='match_parent'>"
    L"<HorizontalLayout padding='0,0,8,0' min-height='50' height='wrap_content'>"
      L"<Label width='200' background-color='0x0' textcolor='0xFFFFFFFF' font-size='20' name='HelpTitle' height='wrap_content'/>"
...
CHAR16 *mHotkeyItemChilds = L""
  L"<VerticalLayout padding='2,2,2,2' name='ItemLayout' height='match_parent' background-color='0x0'>"
    ...
    L"</HorizontalLayout>"
    L"<Label background-color='0x0' name='HelpText' text-align='center' height='23' padding='4,0,4,0' font-size='15' textcolor='0xFFFFFFFF'/>"
...
CHAR16 *mFrontPageItemChilds = L""
  ...
  L"<VerticalLayout padding='15,20,15,20' name='ItemLayout'>"
    ...
    L"</HorizontalLayout>"
    L"<Label background-color='0x0' name='menu_prompt' text-align='center' height='23' padding='8,0,0,0' font-size='15' textcolor='0xFFFFFFFF'/>"
    L"<Label height='7'/>"
...
CHAR16 *mSetupMenuItemChilds = L""
  L"<VerticalLayout>"
    ...
    L"</VerticalLayout>"
    L"<VerticalLayout/>"
    L"<Label background-color='0x0' name='text' text-align='center' height='33' padding='4,0,8,0' font-size='20' textcolor='0xFFFFFFFF'/>"
  L"</VerticalLayout>";
...
CHAR16 *mSubtitleChilds = L""
  ...
  L"<VerticalLayout height='35' width='match_parent'>"
    L"<Label name='OptionPrompt' background-color='0x0' text-align='singleline' padding='0,0,0,20' font-size='20' textcolor='0xFFFFFFFF' text-overflow='ellipsis'/>"
    L"<Control height='1' width='match_parent'/>"
  L"</VerticalLayout>";
...
CHAR16 *mStatementChilds = L""
  ...
  L"<Texture float='true' name='HotBkg' background-image='@SpSelectedBkg' background-image-style='stretch' background-color='0x0' visibility='false'/>"
  L"<HorizontalLayout>"
    L"<Control width='60' name='RefImagePadding' padding='10,17,10,18'>"
...
CHAR16 *mH2OTextOpChilds = L""
  ...
  L"<HorizontalLayout child-padding='2' width='match_parent' min-height='35' height='wrap_content'>"
    L"<Label background-color='0x0' name='OptionPrompt' min-height='35' height='wrap_content' padding='7,0,7,60' width='258' font-size='20' textcolor='0xFFFFFFFF'/>"
    L"<Label background-color='0x0' name='OptionValue' text-align='center' min-height='35' height='wrap_content' padding='7,0,7,0' width='258' font-size='20' textcolor='0xFFFFFFFF'/>"
      ...
      L"<HorizontalLayout padding='10,0,0,0' visibility='false' name='DialogPasswordInput' height='51'>"
        ...
        L"<VerticalLayout padding='6,8,6,8' background-color='0xFFF2F2F2' height='41'>"
          L"<Control padding='1,1,1,1' background-color='0xFF999999' height='29'>"
            L"<UiEdit name='ConfirmPasswordInput' focusbkcolor='@menulightcolor' focustextcolor='0xFF404040' height='27' padding='7,3,0,3' background-color='0xFFF2F2F2' password='true'/>"
          L"</Control>"
        L"</VerticalLayout>"
      L"</HorizontalLayout>"
    ...
    L"<VerticalLayout padding='20,30,20,30' background-image='@DialogBkg' background-image-style='stretch'>"
      ...
      L"<HorizontalLayout padding='0,0,10,0' name='DialogPasswordInput' height='51'>"
        L"<VerticalLayout padding='6,8,6,8' background-color='0xFFF2F2F2' height='41'>"
          L"<Control padding='1,1,1,1' background-color='0xFF999999' height='29'>"
            L"<HorizontalLayout>"
              L"<UiEdit font-size='19' padding='7,3,0,22' name='InputNumericText' background-color='0xFFF2F2F2' focusbkcolor='@menulightcolor' focustextcolor='0xFF404040'  height='27' tabstop='true' taborder='1'  valuetype='dec'/>"
              L"<Label name='Prefix' text=''  font-size='19' height='27' width='wrap_content' background-color='0x00000000' float='true' />"
            L"</HorizontalLayout>"
          L"</Control>"
        L"</VerticalLayout>"
...
CHAR16 *mOrderedListOptionChilds = L""
  L"<HorizontalLayout width='-1' background-color='0x0' name='Option' height='40'>"
