...
//         (socket,die,gpio,function,        output,           pullup)
    ...
    GPIO_DEFINITION (13,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // CPU_INT1#
    GPIO_DEFINITION (14,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC4# Arista: CPU_TPM_SPI_IRQ_L
    GPIO_DEFINITION (16,  GPIO_FUNCTION_0,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC0#
    GPIO_DEFINITION (17,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC1# (Arista: PCIE_WAKE_L)
    GPIO_DEFINITION (18,  GPIO_FUNCTION_0,  GPIO_NA, GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC2# (Arista: PCIE_RST1_L_ALT)
    ...
    GPIO_DEFINITION (42,  GPIO_FUNCTION_0,  GPIO_OUTPUT_LOW, GPIO_PU_EN,     GPIO_STICKY_DIS),   // GPP_10G_SELECT => High=10G, Low=x2  NVME ( work with AGPIO89)(Arista: USB_ENABLE)
    ...
    GPIO_DEFINITION (86,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PD_EN,     GPIO_STICKY_DIS),   // AGPIO86 => High for LPC and Low for eMMC & SD (Need reworks for SD)Arista FPGA_CRC_ERR
...
//  {mPortPresent, mDevAddress, mDevFunction, mMaxLinkSpeed, mAspm, mAspmL1_1, mAspmL1_2, 0, mHotplug, {0, mMaxLinkCap, 0, mClkPmSupport}, {0, 0, 0}, DxioEndpointDetect}
    { // DEVICE_ID_DT                       Entry 1
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 4, 4, HotPluggableDisabled, DEVICE_ID_DT),
      DXIO_PORT_DATA_INITIALIZER_PCIE (
        DxioPortEnabled,                      // Port Present
        1,                                    // Requested Device
	...
	{ // DEVICE_ID_DT                       Entry 1
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 5, 5, HotPluggableDisabled, DEVICE_ID_DT),
      DXIO_PORT_DATA_INITIALIZER_PCIE (
        DxioPortEnabled,                      // Port Present
        1,                                    // Requested Device
...
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTable_RV2 = {
  ...
  {   // DXIO_PORT_DESCRIPTOR
    ...
    { // P0 - Ehernet Port 0        		Entry 6
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioUnusedEngine, 0, 0, HotPluggableDisabled, 1),
      DXIO_PORT_DATA_INITIALIZER_ENET (
        DxioPortDisabled,            // Port Present
        0,    /// mPortNum
        0,    /// mPlatConf 		(10G Base T => Default, 8 = SFP+)
...
//  }
  PcdSet32(PcdTelemetry_VddcrVddfull_Scale_Current, 35000);  // mA
  PcdSet32(PcdTelemetry_VddcrVddOffset, 0);
  PcdSet32(PcdTelemetry_VddcrSocfull_Scale_Current, 10000);   // mA
