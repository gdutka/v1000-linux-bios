  ...
  )
{
  ...
  Status = (**PeiServices).NotifyPpi ((CPM_PEI_SERVICES**)PeiServices, &mCpmPtGpioInitPeimNotify);
  ...
  )
{
...
#ifndef AGESA_V9
  Status = (**PeiServices).NotifyPpi ((CPM_PEI_SERVICES**)PeiServices, &mAmdCpmGpioInitStage1PeimNotify);
#else
  ...
  Status = (**PeiServices).NotifyPpi ((CPM_PEI_SERVICES**)PeiServices, &mAmdCpmGpioInitStage2PeimNotify);
  if (EFI_ERROR (Status)) {
    return Status;
  }
