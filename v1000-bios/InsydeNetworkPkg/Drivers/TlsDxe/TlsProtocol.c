  ...
  )
{
  ...
  if(RequestBuffer == NULL && RequestSize == 0) {
    ...
    case EfiTlsSessionNotStarted:
      ...
      // ClientHello.
      //
//      AsciiPrint ("EfiTlsSessionNotStarted\n");
    ...
    case EfiTlsSessionClosing:
      ...
      //
//      AsciiPrint ("EfiTlsSessionClosing\n");
...
//      AsciiPrint ("TlsDoHandshake in Receive\n");
      Status = TlsDoHandshake (
                 Instance->TlsConn,
                 RequestBuffer,
                 RequestSize,
...
//      AsciiPrint ("TlsHandleAlert in Receive\n");
      Status = TlsHandleAlert (
                 Instance->TlsConn,
                 RequestBuffer,
                 RequestSize,
