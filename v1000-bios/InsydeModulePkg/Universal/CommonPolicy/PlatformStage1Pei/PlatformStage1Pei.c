  ...
  )
{
  ...
  if (Status == EFI_ALREADY_STARTED) {
    ...
    DEBUG ((DEBUG_INFO, "OemKernelServices Call: OemSvcEcInit \n"));
    OemSvcStatus = OemSvcEcInit ();
    DEBUG ((DEBUG_INFO, "OemKernelServices OemSvcEcInit Status: %r\n", OemSvcStatus));

    //
    // OemServices
    //
    DEBUG ((DEBUG_INFO, "OemKernelServices Call: OemSvcInitPlatformStage1 \n"));
    OemSvcStatus = OemSvcInitPlatformStage1 ();
    DEBUG ((DEBUG_INFO, "OemKernelServices OemSvcInitPlatformStage1 Status: %r\n", OemSvcStatus));
