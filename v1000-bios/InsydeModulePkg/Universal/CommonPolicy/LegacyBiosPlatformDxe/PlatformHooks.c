  ...
  )
{
  ...
  case EfiPlatformHookPrepareToScanRom:
    ...
    // OemServices
    //
    DEBUG ((DEBUG_INFO, "OemKernelServices Call: OemSvcInstallPciRomSwitchTextMode \n"));
    Status = OemSvcInstallPciRomSwitchTextMode (
               DeviceHandle,
               &ForceSwitchTextMode
               );
    DEBUG ((DEBUG_INFO, "OemKernelServices OemSvcInstallPciRomSwitchTextMode Status: %r\n", Status));
