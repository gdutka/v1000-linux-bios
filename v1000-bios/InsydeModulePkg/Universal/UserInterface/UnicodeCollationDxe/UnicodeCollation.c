  ...
  )
{
  ...
  UINTN       Index2;
  CHAR8       *CaseMap;
  EFI_UNICODE_COLLATION_PROTOCOL     *UnicodeCollation2;
  ...
  UnicodeCollation2 = AllocateCopyPool (sizeof (UnicodeCollation), &UnicodeCollation);
  ASSERT (UnicodeCollation2 != NULL);
  if (UnicodeCollation2 == NULL) {
    return EFI_OUT_OF_RESOURCES;
  }
