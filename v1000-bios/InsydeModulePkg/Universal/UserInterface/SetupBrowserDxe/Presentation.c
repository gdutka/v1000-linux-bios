  ...
  )
{
  ...
  StrCpyS (Destination + Length, (DestBufLen - Length) / sizeof(CHAR16), Source);
}
  ...
  )
{
  ...
  if (gDeviceManagerSetup) {
    ...
    // OemServices
    //
    DEBUG ((DEBUG_INFO, "OemKernelServices Call: OemSvcUpdateFormLen \n"));
    OemSvcStatus = OemSvcUpdateFormLen (
                     NULL,
    ...
    DEBUG ((DEBUG_INFO, "OemKernelServices OemSvcUpdateFormLen Status: %r\n", OemSvcStatus));
