...
BANNER_DATA           *gBannerData = NULL;
EFI_HII_HANDLE        gFrontPageHandle = NULL;
UINTN                 gClassOfVfr = 0;
UINTN                 gFunctionKeySetting = 0;
BOOLEAN               gResetRequired = FALSE;
BOOLEAN               gExitRequired = FALSE;
BOOLEAN               gNvUpdateRequired = FALSE;
EFI_HII_HANDLE        gHiiHandle = NULL;
UINT16                gDirection = 0;
EFI_SCREEN_DESCRIPTOR gScreenDimensions = {0};
EFI_HII_ANIMATION_PACKAGE_HDR *gAnimationPackage = NULL;
BOOLEAN               gGraphicsEnabled = FALSE;
UINTN                 gFooterHeight = 0;
...
//
CHAR16            *gFunctionNineString = NULL;
CHAR16            *gFunctionTenString = NULL;
CHAR16            *gEnterString = NULL;
CHAR16            *gEnterCommitString = NULL;
CHAR16            *gEnterEscapeString = NULL;
CHAR16            *gEscapeString = NULL;
CHAR16            *gSaveFailed = NULL;
CHAR16            *gMoveHighlight = NULL;
CHAR16            *gMakeSelection = NULL;
CHAR16            *gDecNumericInput = NULL;
CHAR16            *gHexNumericInput = NULL;
CHAR16            *gToggleCheckBox = NULL;
CHAR16            *gPromptForData = NULL;
CHAR16            *gPromptForPassword = NULL;
CHAR16            *gPromptForNewPassword = NULL;
CHAR16            *gConfirmPassword = NULL;
CHAR16            *gConfirmError = NULL;
CHAR16            *gPassowordInvalid = NULL;
CHAR16            *gSamePasswordError = NULL;
CHAR16            *gPressEnter = NULL;
CHAR16            *gEmptyString = NULL;
CHAR16            *gAreYouSure = NULL;
CHAR16            *gYesResponse = NULL;
CHAR16            *gNoResponse = NULL;
CHAR16            *gMiniString = NULL;
CHAR16            *gPlusString = NULL;
CHAR16            *gMinusString = NULL;
CHAR16            *gAdjustNumber = NULL;
CHAR16            *gSaveChanges = NULL;
CHAR16            *gOptionMismatch = NULL;
CHAR16            *gSetupWarning = NULL;
CHAR16            *gSetupNotice = NULL;
CHAR16            *gChangesSaved = NULL;
CHAR16            *gContinue = NULL;
CHAR16            *gPasswordChangesSaved = NULL;
  ...
  )
{
  ...
  NewStringSize = StrSize (*Dest) + StrSize (Src) - 1;
  NewString = AllocateZeroPool (NewStringSize);
  ASSERT (NewString != NULL);
  if (NewString == NULL) {
    return ;
  }

  StrCpyS (NewString, NewStringSize / sizeof(CHAR16), *Dest);
  StrCatS (NewString, NewStringSize / sizeof(CHAR16), Src);
  ...
  )
{
  ...
  if (!Cached) {
    ...
    ConfigRespSize = (StrLen (Storage->ConfigHdr) + Length + 1) * sizeof (CHAR16);
    ConfigResp = AllocateZeroPool (ConfigRespSize);
    ASSERT (ConfigResp != NULL);
    if (ConfigResp == NULL) {
      return EFI_OUT_OF_RESOURCES;
    }

    StrCpyS (ConfigResp, ConfigRespSize / sizeof(CHAR16), Storage->ConfigHdr);
    if (IsBufferStorage) {
      StrCatS (ConfigResp, ConfigRespSize / sizeof(CHAR16), Question->BlockName);
      StrCatS (ConfigResp, ConfigRespSize / sizeof(CHAR16), L"&VALUE=");
    } else {
      StrCatS (ConfigResp, ConfigRespSize / sizeof(CHAR16), L"&");
      StrCatS (ConfigResp, ConfigRespSize / sizeof(CHAR16), Question->VariableName);
      StrCatS (ConfigResp, ConfigRespSize / sizeof(CHAR16), L"=");
    }
