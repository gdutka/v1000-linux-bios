  ...
  )
{
  ...
  if (!EFI_ERROR (Status)) {
    ...
    //                                  0x03 - Odd Parity
    //
    mUartNode.Parity                = ((CrConfig->GlobalParity >= 1) && (CrConfig->GlobalParity <= 3)) ? CrConfig->GlobalParity : 1;
    ...
    //                                       0x02 - Software
    //
    mFlowControlNode.FlowControlMap = ((CrConfig->GlobalFlowControl >= 0) && (CrConfig->GlobalFlowControl <= 2)) ? CrConfig->GlobalFlowControl : 0;
