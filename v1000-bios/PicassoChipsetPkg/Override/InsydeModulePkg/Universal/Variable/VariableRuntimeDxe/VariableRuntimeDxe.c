...
//[-start-221012-IB1486854-add]//
   CopyMem (
    &mVariableModuleGlobal->SmmVarBuf,
    &mSmmVariableGlobal->ProtectedModeVariableModuleGlobal->SmmVarBuf,
    sizeof (mVariableModuleGlobal->SmmVarBuf)
    );

  CopyMem (
    &mVariableModuleGlobal->SmmVarBufSize,
    &mSmmVariableGlobal->ProtectedModeVariableModuleGlobal->SmmVarBufSize,
    sizeof (mVariableModuleGlobal->SmmVarBufSize)
    );  
//[-end-221012-IB1486854-add]//
