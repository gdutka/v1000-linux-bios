...
//[-start-190617-IB09860082-modify]//
    if (FeaturePcdGet (PcdH2OIdeSupported)) {
      LegacyBiosBuildBbs (Private, mBbsTable);
    }
//[-end-190617-IB09860082-modify]//
    ...
    // OemServices
    //
    DEBUG ((DEBUG_INFO, "OemKernelServices Call: OemSvcUpdateBbsTable \n"));
    Status = OemSvcUpdateBbsTable (
               EfiToLegacy16BootTable,
               LocalBbsTable
               );
    DEBUG ((DEBUG_INFO, "OemKernelServices OemSvcUpdateBbsTable Status: %r\n", Status));
  }
