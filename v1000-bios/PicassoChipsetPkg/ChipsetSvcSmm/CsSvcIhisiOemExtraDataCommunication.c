...
;***************************************************************************
;* Copyright (c) 2017 - 2023, Insyde Software Corp. All Rights Reserved.
;*
...
#include <Uefi.h>
//[-start-230823-IB19090047-modify]//
  ...
  )
{
  ...
  //   RomBaseAddress -= PcdGet32 (PcdFlashAreaSize);
  // }
