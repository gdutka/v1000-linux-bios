  ...
  )
{
  ...
  Setup_Config->CbsCmnCpuCpb = 0;                                       // Core Performance Boost
  Setup_Config->CbsCmnCpuGlobalCstateCtrl = 1;                          // Global C-state Control
  ...
  Setup_Config->CbsCmnGnbSMUSystemConfig = 0x2;                         // System Configuration
  ...
  Setup_Config->CbsCmnFchSataEnable = 0x0;                              // SATA Controller
  ...
  Setup_Config->CbsDbgFchEmmcEnable = 10;                               // eMMC/SD Configure
  ...
  Setup_Config->CbsCmnToggleAllPwrGoodOnCf9 = 0;                        // Toggle All PwrGood On Cf9
  ...
  Setup_Config->Header.CbsVariableStructUniqueValue = 0xfbbacfe1;
