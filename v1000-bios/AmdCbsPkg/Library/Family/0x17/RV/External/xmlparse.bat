...
rem save previous AmdCbsVariable.h as base
  ...
  @REM Only copy files if they differ.  Prevents needless rebuild of files.
  fc %WORKSPACE%\AmdCbsPkg\%CBS_LIB_FAMILY_PATH%\ResourceRVFP5\AmdCbsVariable.h %WORKSPACE%\AmdCbsPkg\Include\Library\AmdCbsVariable.h > nul 2>&1 || @copy /y %WORKSPACE%\AmdCbsPkg\%CBS_LIB_FAMILY_PATH%\ResourceRVFP5\AmdCbsVariable.h %WORKSPACE%\AmdCbsPkg\Include\Library
  fc %WORKSPACE%\AmdCbsPkg\%CBS_LIB_FAMILY_PATH%\ResourceRVFP5\AmdCbsVariable.h %WORKSPACE%\AmdCbsPkg\Include\Library\AmdCbsVariableRVFP5.h > nul 2>&1 || @copy /y %WORKSPACE%\AmdCbsPkg\%CBS_LIB_FAMILY_PATH%\Resource\AmdCbsVariable.h %WORKSPACE%\AmdCbsPkg\Include\Library\AmdCbsVariableRVFP5.h
  fc %WORKSPACE%\AmdCbsPkg\%CBS_LIB_FAMILY_PATH%\ResourceRVFP5\IdsNvDefRV.h %CBS_AGESA_PATH%\IdsNvDefRV.h > nul 2>&1  || @copy /y %WORKSPACE%\AmdCbsPkg\%CBS_LIB_FAMILY_PATH%\ResourceRVFP5\IdsNvDefRV.h %CBS_AGESA_PATH%
)