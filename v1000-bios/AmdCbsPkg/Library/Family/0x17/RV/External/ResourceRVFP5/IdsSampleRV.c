...
//RPMC Control
IDS_NV_READ_SKIP (IDSNVID_CMN_SOC_RPMC_CONTROL, &IdsNvValue) {
  switch (IdsNvValue) {
  case IDSOPT_CMN_SOC_RPMC_CONTROL_AUTO:
    break;
  case IDSOPT_CMN_SOC_RPMC_CONTROL_ENABLE:
    break;
  case IDSOPT_CMN_SOC_RPMC_CONTROL_DISABLE:
    break;
  default:
    ASSERT (FALSE);
    break;
...
//SMBUS SPD Voltage
IDS_NV_READ_SKIP (IDSNVID_CMN_SPD_SMBUS_VOLTAGE, &IdsNvValue) {
  switch (IdsNvValue) {
  case IDSOPT_CMN_SPD_SMBUS_VOLTAGE_33V:
    break;
  case IDSOPT_CMN_SPD_SMBUS_VOLTAGE_18V:
    break;
  default:
    ASSERT (FALSE);
    break;
...
IDS_NV_READ_SKIP (IDSNVID_CMN_GNB_SMU_SYSTEM_CONFIG, &IdsNvValue) {
  switch (IdsNvValue) {
  case IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_6WSDP15:
    break;
  case IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_6WEMBEDDED16EMBEDDED:
    break;
  case IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_8WPORCONFIGURATION13EMBEDDED:
    break;
  case IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_10WPORCONFIGURATION14EMBEDDED:
    break;
  case IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_12WPORCONFIGURATION10EMBEDDED:
    break;
  case IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_15WPORCONFIGURATION11EMBEDDED:
    break;
  case IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_25WPORCONFIGURATION12EMBEDDED:
    break;
...
IDS_NV_READ_SKIP (IDSNVID_CMN_GNB_GFX_UMA_FRAME_BUFFER_SIZE, &IdsNvValue) {
  ...
  case IDSOPT_CMN_GNB_GFX_UMA_FRAME_BUFFER_SIZE_4G:
    break;
  case IDSOPT_CMN_GNB_GFX_UMA_FRAME_BUFFER_SIZE_6G:
    break;
...
//UMA Above 4G
IDS_NV_READ_SKIP (IDSNVID_DF_CMN_UMA_ABOVE4_G, &IdsNvValue) {
  switch (IdsNvValue) {
  case IDSOPT_DF_CMN_UMA_ABOVE4_G_DISABLED:
    break;
  case IDSOPT_DF_CMN_UMA_ABOVE4_G_ENABLED:
    break;
  case IDSOPT_DF_CMN_UMA_ABOVE4_G_AUTO:
    break;
  default:
    ASSERT (FALSE);
    break;
...
IDS_NV_READ_SKIP (IDSNVID_CMN_FCH_UART0_LEGACY_CONFIG, &IdsNvValue) {
  ...
  case IDSOPT_CMN_FCH_UART0_LEGACY_CONFIG_DISABLED:
    break;
  case IDSOPT_CMN_FCH_UART0_LEGACY_CONFIG_COM10X3F8:
    break;
  case IDSOPT_CMN_FCH_UART0_LEGACY_CONFIG_COM20X2F8:
    break;
  case IDSOPT_CMN_FCH_UART0_LEGACY_CONFIG_COM30X3E8:
    break;
  case IDSOPT_CMN_FCH_UART0_LEGACY_CONFIG_COM40X2E8:
    break;
...
IDS_NV_READ_SKIP (IDSNVID_CMN_FCH_UART1_LEGACY_CONFIG, &IdsNvValue) {
  ...
  case IDSOPT_CMN_FCH_UART1_LEGACY_CONFIG_DISABLED:
    break;
  case IDSOPT_CMN_FCH_UART1_LEGACY_CONFIG_COM10X3F8:
    break;
  case IDSOPT_CMN_FCH_UART1_LEGACY_CONFIG_COM20X2F8:
    break;
  case IDSOPT_CMN_FCH_UART1_LEGACY_CONFIG_COM30X3E8:
    break;
  case IDSOPT_CMN_FCH_UART1_LEGACY_CONFIG_COM40X2E8:
    break;
...
IDS_NV_READ_SKIP (IDSNVID_CMN_FCH_UART2_LEGACY_CONFIG, &IdsNvValue) {
  ...
  case IDSOPT_CMN_FCH_UART2_LEGACY_CONFIG_DISABLED:
    break;
  case IDSOPT_CMN_FCH_UART2_LEGACY_CONFIG_COM10X3F8:
    break;
  case IDSOPT_CMN_FCH_UART2_LEGACY_CONFIG_COM20X2F8:
    break;
  case IDSOPT_CMN_FCH_UART2_LEGACY_CONFIG_COM30X3E8:
    break;
  case IDSOPT_CMN_FCH_UART2_LEGACY_CONFIG_COM40X2E8:
    break;
...
IDS_NV_READ_SKIP (IDSNVID_CMN_FCH_UART3_LEGACY_CONFIG, &IdsNvValue) {
  ...
  case IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG_DISABLED:
    break;
  case IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG_COM10X3F8:
    break;
  case IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG_COM20X2F8:
    break;
  case IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG_COM30X3E8:
    break;
  case IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG_COM40X2E8:
    break;
...
//Uart Driver Type
IDS_NV_READ_SKIP (IDSNVID_CMN_FCH_UART_DRIVER_TYPE, &IdsNvValue) {
  switch (IdsNvValue) {
  switch (PcdGet8 (FchUartDriverType)) {
  case IDSOPT_CMN_FCH_UART_DRIVER_TYPE_AMDUARTDRIVER:
    break;
  case IDSOPT_CMN_FCH_UART_DRIVER_TYPE_AMDSERIALDRIVER:
    break;
  default:
    ASSERT (FALSE);
    break;
