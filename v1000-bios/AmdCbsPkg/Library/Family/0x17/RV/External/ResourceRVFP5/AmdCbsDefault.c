  ...
  )
{
  ...
  Setup_Config->CbsCmnSocRpmcControl = 1;                               // RPMC Control
  ...
  Setup_Config->CbsCmnPersistentHigh = 1;                               // Persistent memory Base High
  ...
  Setup_Config->CbsDfCmnCstateCtrl = 0;                                 // DF C-state control
  ...
  Setup_Config->CbsCmnSpdSmbusVoltage = 0;                              // SMBUS SPD Voltage
  ...
  Setup_Config->CbsCmnMemCtrllerPwrDnEnDdr4 = 0;                        // Power Down Enable
  ...
  Setup_Config->CbsCmnMemCtrllerRttNomDdr4 = 0x5;                      // RttNom
  Setup_Config->CbsCmnMemCtrllerRttWrDdr4 = 0x0;                       // RttWr
  Setup_Config->CbsCmnMemCtrllerRttParkDdr4 = 0x0;                     // RttPark
  Setup_Config->CbsCmnMemDataPoisoningDdr4 = 0;                         // Data Poisoning
  Setup_Config->CbsCmnMemDisMemErrInj = 1;                              // Disable Memory Error Injection
  Setup_Config->CbsCmnMemCtrllerDramEccSymbolSizeDdr4 = 1;              // DRAM ECC Symbol Size
  ...
  Setup_Config->CbsDbgGnbAudioIOs = 7;                                  // Audio IOs
  Setup_Config->CbsCmnSystemTemperatureTracking = 0xF;                  // System Temperature Tracking
  Setup_Config->CbsCmnGnbGfxiGPU_CONTROL = 0x0;                         // Integrated Graphics Controller
  ...
  Setup_Config->CbsDfCmnUmaAbove4G = 0xFF;                              // UMA Above 4G
  ...
  Setup_Config->CbsCmnFchSataEnable = 0x1;                              // SATA Controller
  ...
  Setup_Config->CbsDbgFchSataAggresiveDevSlpP0 = 0x0;                   // Aggresive SATA Device Sleep Port 0
  ...
  Setup_Config->CbsCmnFchI2C0Config = 0x1;                              // I2C 0 Enable
  Setup_Config->CbsCmnFchI2C1Config = 0xf;                              // I2C 1 Enable
  Setup_Config->CbsCmnFchI2C2Config = 1;                                // I2C 2 Enable
  Setup_Config->CbsCmnFchI2C3Config = 0x1;                              // I2C 3 Enable
  Setup_Config->CbsCmnFchI2C4Config = 0xf;                              // I2C 4 Enable
  Setup_Config->CbsCmnFchI2C5Config = 0xf;                              // I2C 5 Enable
  Setup_Config->CbsCmnFchUart0Config = 0x1;                             // Uart 0 Enable
  Setup_Config->CbsCmnFchUart0LegacyConfig = 0xf;                       // Uart 0 Legacy Options
  Setup_Config->CbsCmnFchUart1Config = 0x0;                             // Uart 1 Enable
  Setup_Config->CbsCmnFchUart1LegacyConfig = 0xf;                       // Uart 1 Legacy Options
  Setup_Config->CbsCmnFchUart2Config = 0x0;                             // Uart 2 Enable (no HW FC)
  Setup_Config->CbsCmnFchUart2LegacyConfig = 0xf;                       // Uart 2 Legacy Options
  Setup_Config->CbsCmnFchUart3Config = 0x0;                             // Uart 3 Enable (no HW FC)
  Setup_Config->CbsCmnFchUart3LegacyConfig = 0xf;                       // Uart 3 Legacy Options
  Setup_Config->CbsCmnFchUartDriverType = 1;                            // Uart Driver Type
  Setup_Config->CbsCmnFchEspiConfig = 0x1;                              // ESPI Enable
  Setup_Config->CbsCmnFchXgbe0Enable = 0x1;                             // XGBE0 enable
  Setup_Config->CbsCmnFchXgbe1Enable = 0x0;                             // XGBE1 enable
  Setup_Config->CbsDbgFchEmmcEnable = 0;                                // eMMC/SD Configure
  Setup_Config->CbsDbgFchEmmcDriverType = 0x0;                          // Driver Type
  Setup_Config->CbsDbgFchEmmcD3Support = 0xf;                           // D3 Cold Support
  Setup_Config->CbsDbgFchEmmcBoot = 0x1;                                // eMMC Boot
  Setup_Config->CbsCmnFchLpcClockRunEn = 0xf;                           // LPC Clock Run control
  Setup_Config->CbsCmnToggleAllPwrGoodOnCf9 = 1;                        // Toggle All PwrGood On Cf9
  ...
  Setup_Config->Header.CbsVariableStructUniqueValue = 0x8c8b7fad;
