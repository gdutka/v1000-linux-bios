...
#define _IDS_NV_ID_RV_H_
  ...
  #define IDSNVID_CMN_PERSISTENT_LOW   (0x012E) //Persistent memory Base Low
#endif

#ifndef IDSNVID_CMN_PERSISTENT_HIGH
  #define IDSNVID_CMN_PERSISTENT_HIGH   (0x012F) //Persistent memory Base High
#endif

#ifndef IDSNVID_CMN_PERSISTENT_SIZE_LOW
  #define IDSNVID_CMN_PERSISTENT_SIZE_LOW   (0x0130) //Persistent memory reserved size Low
#endif

#ifndef IDSNVID_CMN_PERSISTENT_SIZE_HIGH
  #define IDSNVID_CMN_PERSISTENT_SIZE_HIGH   (0x0131) //Persistent memory reserved size High
#endif

#ifndef IDSNVID_CMN_SPD_SMBUS_VOLTAGE
  #define IDSNVID_CMN_SPD_SMBUS_VOLTAGE   (0x0132) //SMBUS SPD Voltage
#endif

#ifndef IDSNVID_CMN_MEM_DIS_MEM_ERR_INJ
  #define IDSNVID_CMN_MEM_DIS_MEM_ERR_INJ   (0x0133) //Disable Memory Error Injection
#endif

#ifndef IDSNVID_CMN_FCH_UART_DRIVER_TYPE
  #define IDSNVID_CMN_FCH_UART_DRIVER_TYPE   (0x0134) //Uart Driver Type
#endif
