...
function main() {
	...
	APCB_DATA_TYPE_FILE_LIST="\
	  ...
	  ApcbData_RV_GID_0x1704_Type_PsOdtPatSODIMMDdr4\
	  ApcbData_RV_GID_0x1704_Type_PsCadBusSODIMMDdr4 \
	  ApcbData_RV_GID_0x1704_Type_PsDataBusSODIMMDdr4\
	  ApcbData_RV_GID_0x1704_Type_PsMaxFreqSODIMMDdr4\
	  ApcbData_RV_GID_0x1704_Type_PsStretchFreqSODIMMDdr4\
