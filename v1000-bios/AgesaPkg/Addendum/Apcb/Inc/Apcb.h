...
typedef enum {
  ...
  APCB_TOKEN_CONFIG_MEM_RESERVE_ADDR_LOW,
  APCB_TOKEN_CONFIG_MEM_RESERVE_ADDR_HIGH,
  APCB_TOKEN_CONFIG_MEM_RESERVE_SIZE_LOW,
  APCB_TOKEN_CONFIG_MEM_RESERVE_SIZE_HIGH,
